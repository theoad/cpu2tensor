...
| C2T-25 Context-only x86 system profile | Implemented and checked; ready for client acceptance | Independent context selection, benign paging oracle/public fallback, two-vCPU Pool acceptance and 12-run cost matrix; [guide](context-only.md) |
