...
inline constexpr uint64_t feature_context_filter = 1 << 21;
...
inline constexpr size_t context_filter_bytes = 80;
...
enum class Kind : uint16_t {
    ...
    context_filter = 18, observation_summary = 19, reduced_context = 20
};
